  ...
  const markup = `
    <div class="cookie-consent" id="cookie-consent" role="dialog" aria-live="polite" aria-label="Уведомление об использовании cookie">
      ...
      <p class="cookie-consent__text cookie-consent__text--desktop">
        ...
        <span class="cookie-consent__text-line"><a href="${privacyUrl}" class="cookie-consent__link">Политикой использования файлов cookie.</a></span>
      </p>
      <p class="cookie-consent__text cookie-consent__text--mobile">
        ...
        <span class="cookie-consent__text-line">соглашаетесь с нашей <a href="${privacyUrl}" class="cookie-consent__link">Политикой</a></span>
        <span class="cookie-consent__text-line"><a href="${privacyUrl}" class="cookie-consent__link">использования файлов cookie.</a></span>
      </p>
